...
_ISO_NO_PREVIEW_GOLDEN = (
    ...
    (2, 5, "consistency", "Check remix consistency"),
    (3, 10, "policy", "Apply beginner-safe policy"),
    (4, 15, "compatibility", "Check release compatibility"),
    (5, 20, "import_scripts", "Import legacy scripts"),
    (6, 25, "diff_preview", "Preview changes"),
    (7, 30, "prepare", "Prepare workspace"),
    (8, 35, "extract_iso", "Extract ISO"),
    (9, 74, "unpack_filesystem", "Unpack live filesystem"),
    (10, 149, "branding", "Debrand source identity"),
    (11, 158, "configure_apt", "Configure repositories"),
    (12, 168, "apt_cache", "Configure apt cache"),
    (13, 173, "ppa", "Configure verified PPAs"),
    (14, 183, "release_track", "Configure release track"),
    (15, 188, "system_sync", "Sync system packages"),
    (16, 208, "autodrivers", "Auto-install drivers"),
    (17, 223, "apply_packages", "Apply package plan"),
    (18, 322, "desktop_source", "Build desktop from source"),
    (19, 351, "install_snaps", "Install snaps"),
    (20, 371, "size_analysis", "Analyze image size"),
    (21, 376, "vuln_scan", "Scan packages for known CVEs"),
    (22, 381, "snapshot", "Create rollback snapshot"),
    (23, 396, "customize_system", "Apply ISO personalization"),
    (24, 406, "branding", "Apply branding"),
    (25, 416, "users", "Configure users and groups"),
    (26, 421, "systemd", "Configure systemd services"),
    (27, 426, "network", "Configure network"),
    (28, 431, "kiosk", "Configure kiosk mode"),
    (29, 436, "oem", "Configure OEM mode"),
    (30, 441, "snapshot", "Create rollback snapshot"),
    (31, 455, "kernel_module", "Build kernel payload"),
    (32, 480, "secure_boot", "Secure Boot workflow"),
    (33, 490, "reproducible", "Pin reproducible build inputs"),
    (34, 495, "run_hooks", "Run customization hooks"),
    (35, 505, "finalize_packages", "Finalize package set"),
    (36, 515, "package_evidence", "Seal package inputs"),
    (37, 545, "sanitize_target", "Sanitize target"),
    (38, 559, "snapshot", "Create rollback snapshot"),
    (39, 574, "health", "Beginner-safe health report"),
    (40, 579, "autoinstall", "Generate autoinstall"),
    (41, 584, "seeds", "Write seeds"),
    (42, 589, "update_metadata", "Update ISO metadata"),
    (43, 599, "rootfs_evidence_capture", "Seal final rootfs identity"),
    (44, 658, "repack_filesystem", "Repack live filesystem"),
    (45, 748, "rootfs_evidence_verify", "Verify packed rootfs identity"),
    (46, 847, "update_checksums", "Update ISO checksums"),
    (47, 856, "rebuild_iso", "Rebuild ISO"),
    (48, 906, "prebuild_vm", "Run prebuild VM lab"),
    (49, 926, "release_artifacts", "Write release artifacts"),
    (50, 936, "bootcheck", "Boot smoke test"),
    (51, 955, "qemu_screenshot", "Capture QEMU screenshot"),
    (52, 965, "html_report", "Write HTML report"),
    (53, 970, "qa_matrix", "Run QA boot matrix"),
    (54, 995, "provenance", "Write SBOM/provenance"),
)
