...
_PHASE_ICONS: dict[BuildPhase, str] = {
    ...
    BuildPhase.FINALIZE_PACKAGES: "package",
    BuildPhase.PACKAGE_EVIDENCE: "shield-check",
    ...
    BuildPhase.ROOTFS_EVIDENCE_CAPTURE: "shield-check",
    BuildPhase.REPACK_FILESYSTEM: "box",
    BuildPhase.ROOTFS_EVIDENCE_VERIFY: "shield-check",
