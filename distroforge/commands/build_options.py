...
def register_build_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--prebuild-vm-ovmf-code", default="", help="OVMF code image; empty auto-detects the installed one")
    parser.add_argument("--prebuild-vm-ovmf-vars", default="", help="OVMF variable store template; empty auto-detects")
