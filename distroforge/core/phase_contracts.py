...
_CONTRACT_DATA: tuple[
    ...
    (
        BuildPhase.VALIDATE,
        "run_preflight",
        ("project definition", "host build tools"),
        ("validation findings",),
        False,
        None,
    ),
    (
        ...
        "run_preflight",
        ("project definition", "build options"),
    ...
    (
        BuildPhase.POLICY,
        "run_preflight",
        ("build options", "policy mode"),
        ("policy report", "trademark clearance"),
        False,
        None,
    ),
    (
    ...
    (
        ...
        ("squashfs root", "ISO tree"),
        True,
        None,
    ),
    (BuildPhase.EXTRACT_ISO, "acquire_source", ("source ISO",), ("ISO tree",), True, None),
    (
    ...
    (
        ...
        ("built desktop .deb", "installed desktop"),
        True,
        None,
    ),
    (
    ...
    (
        ...
        "customize_target",
        ("planned packages", "advisory database"),
        ("CVE findings",),
        False,
        None,
    ),
    ...
    (
        ...
        "customize_target",
        ("branding options",),
        ("logo/GRUB/Plymouth/identity assets",),
        True,
        None,
    ),
    (BuildPhase.USERS, "customize_target", ("user specs",), ("users and groups",), True, None),
    (
        BuildPhase.SYSTEMD,
        "customize_target",
        ("systemd options",),
    ...
    (
        ...
        "customize_target",
        ("network options",),
        ("netplan/DNS/proxy config",),
        True,
        None,
    ),
    (BuildPhase.KIOSK, "customize_target", ("kiosk options",), ("kiosk session",), True, None),
    (
        BuildPhase.OEM,
        "customize_target",
        ("OEM options",),
        ("first-boot/OEM reset flow",),
        True,
        None,
    ),
    (
        ...
        ("compiled module", "refreshed boot assets"),
        True,
    ...
    (
        ...
        "customize_target",
        ("secure boot options",),
        ("module signing", "MOK enrollment plan"),
        True,
        None,
    ),
    (
        ...
        ("verified epoch and snapshot pins",),
        False,
        None,
    ),
    (
        BuildPhase.SNAPSHOT,
        "customize_target",
        ("snapshot options", "target rootfs"),
        ("rollback archives",),
        True,
    ...
    (
        ...
        "assemble_iso",
        ("squashfs root", "ISO tree"),
        ("Casper manifest", "filesystem.size"),
        True,
        None,
    ),
    (
    ...
    (
        ...
        "assemble_iso",
        ("ROOTFS-MANIFEST.json", "filesystem.squashfs"),
        ("ROOTFS-PACKING-VERIFICATION.json",),
        True,
        None,
    ),
    (BuildPhase.UPDATE_CHECKSUMS, "assemble_iso", ("ISO tree",), ("md5sum.txt",), True, None),
    (
        BuildPhase.REBUILD_ISO,
        "assemble_iso",
        ("ISO tree", "witnessed filesystem.squashfs"),
        ("output ISO", "ISO-ASSEMBLY.json"),
        True,
        None,
    ),
    (
        ...
        "assemble_iso",
        ("output ISO", "prebuild VM options"),
        ("VM lab logs",),
        False,
        None,
    ),
    (
        ...
        "assemble_iso",
        ("output ISO",),
        ("SHA256SUMS", "BUILDINFO", "signature"),
        False,
        None,
    ),
    (BuildPhase.BOOTCHECK, "assemble_iso", ("output ISO",), ("boot smoke result",), False, None),
    (
    ...
    (
        ...
        "assemble_iso",
        ("output ISO", "QA scenarios"),
        ("QA matrix results",),
        False,
        None,
    ),
    (BuildPhase.PREVIEW, "assemble_iso", ("output ISO",), ("QEMU preview session",), False, None),
)
